...
- **Import / re-import** – `vendor/bin/typo3 fastblog:import` picks up new and changed files; translated files (same `translationKey`) are linked as TYPO3 translations (`l10n_parent`).
